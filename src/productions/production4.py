...
from ..vertex_params import VertexParams, VertexType
...
from .production3 import _get_common_exterior_neighbors, _get_neighbour_with_correct_position
...
def _create_edges(
    ...
    return [
        ...
        (used_interior_node.id, interior_node_c.id),
