...
from tests.fixtures import graph_for_p10_bigger
from tests.fixtures import correct_graph_after_p10_bigger
...
def test_should_correctly_transform_graph(
        graph_for_p10,
...
def test_should_correctly_transform_bigger_graph(
        graph_for_p10_bigger,
        correct_graph_after_p10_bigger,
        production10
):
    subgraph = production10.find_isomorphic_to_left_side(graph_for_p10_bigger)
    graph_after_p10 = production10.apply(graph_for_p10_bigger, subgraph)

    assert _are_graphs_isomorphic(graph_after_p10, correct_graph_after_p10_bigger)
