...
def test_matches_isomorphism_in_graph_after_first_production(
        graph_after_first_production, production9):
...
def test_does_not_match_isomorphism_in_start_graph(start_graph, production9):
    subgraph = production9.find_isomorphic_to_left_side(start_graph)

    assert subgraph is None

def test_does_not_match_isomorphism_in_graph_after_first_production_wrong_edge(
        graph_after_first_production_wrong_edge, production9):
    subgraph = production9.find_isomorphic_to_left_side(graph_after_first_production_wrong_edge)

    assert subgraph is None

def test_does_not_match_isomorphism_in_graph_after_first_production_wrong_node(
        graph_after_first_production_wrong_node, production9):
    subgraph = production9.find_isomorphic_to_left_side(graph_after_first_production_wrong_node)

    assert subgraph is None

def test_does_not_match_isomorphism_in_graph_after_first_production_wrong_type(
        graph_after_first_production_wrong_type, production9):
    subgraph = production9.find_isomorphic_to_left_side(graph_after_first_production_wrong_type)

    assert subgraph is None


def test_applies_to_graph_after_first_production(
        graph_after_first_production, graph_after_ninth_production, production9):
    subgraph = production9.find_isomorphic_to_left_side(graph_after_first_production)
